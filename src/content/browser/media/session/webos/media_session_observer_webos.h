...
class MediaSessionObserverWebOS final
 ...
 private:
  ...
  // Returns the application id of the web contents coressponding to the
  // session. Returns empty string for invalid session.
  std::string GetAppIdOfWebContents();
  ...
  DISALLOW_COPY_AND_ASSIGN(MediaSessionObserverWebOS);
};
