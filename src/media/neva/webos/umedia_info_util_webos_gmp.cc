...
std::string UMSSourceInfoToJsonString(const std::string& media_id,
...
std::string UMSVideoInfoToJsonString(const std::string& media_id,
...
std::string UMSAudioInfoToJsonString(const std::string& media_id,
